                  ...
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-2 w-56 bg-white border border-slate-200 rounded-xl shadow-lg py-2 z-20 overflow-hidden">
                      <div className="px-4 py-3 border-b border-slate-100">
                       ...
                       <div className="py-1">
                        <Link to="/yeu-thich" onClick={() => setShowUserMenu(false)} className="flex items-center gap-3 px-4 py-2.5 hover:bg-slate-50 text-slate-700 text-sm">
                        ...
                        <Link to="/khieu-nai" onClick={() => setShowUserMenu(false)} className="flex items-center gap-3 px-4 py-2.5 hover:bg-slate-50 text-slate-700 text-sm">
