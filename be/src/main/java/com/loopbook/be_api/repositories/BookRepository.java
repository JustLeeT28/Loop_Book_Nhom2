...
public interface BookRepository extends JpaRepository<Book, String> {
    ...
    // Các method sắp xếp: bài có boostExpiry > now lên trước, sau đó mới đến createdAt DESC
    ...
    // Giữ lại các method cũ cho các trường hợp không cần ưu tiên boost (user listings, etc)
